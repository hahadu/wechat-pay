 ...
 *  +----------------------------------------------------------------------
 *  | Date: 2020/10/11 下午5:40
 *  +----------------------------------------------------------------------
 *  | Description:   wechat-pay jsApiPay
 *  +----------------------------------------------------------------------
 **/

namespace Hahadu\WechatPay\Library;
use Hahadu\WechatPay\Kernel\WxPayException;
use Hahadu\WechatPay\Kernel\WxPayData\WxPayJsApiPay;
...
class WechatJsApiPay
{
     ...
     *
     * @return string|int openid 用户的openid
     */
    private $config;
